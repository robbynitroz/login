...
<div class="login-big-wrapper">
    <div class="offer-wrapper offer-wrapper-xs">
        <a href="#" class="terms-link" onclick="return false"><?php echo $GLOBALS['term_title']; ?></a>

        <h1 class="heading">Go online</h1>
        <?php
        echo '<form class="go-online-form" action="http://' . $nasip . ':64873/login?username=' . $macaddress . '&password=' . $macaddress . '&dst=' . $url . '" method="post">';
        ?>
        <button class="go-online-button">Something here to</button>
        </form>
        <a href="" class="check-link">Something here <span>></span></a>
